...
return {
    {
        ...
        event = "LspAttach",
        keys = {
            { "<leader>db", function() require("dap").toggle_breakpoint() end, silent = true, desc = "DAP breakpoint toggle (nvim-dap)" },
            {
                "<leader>da",
                function()
            ...
            { "<leader>dc", function() require("dap").continue() end, silent = true, desc = "DAP run/continue (nvim-dap)" },
            { "<leader>dC", function() require("dap").run_to_cursor() end, silent = true, desc = "DAP run to cursor (nvim-dap)" },
            { "<leader>dg", function() require("dap").goto_() end, silent = true, desc = "DAP goto (nvim-dap)" },
            { "<leader>di", function() require("dap").step_into() end, silent = true, desc = "DAP step into (nvim-dap)" },
            ...
            { "<leader>dO", function() require("dap").step_over() end, silent = true, desc = "DAP step over (nvim-dap)" },
            { "<leader>dP", function() require("dap").pause() end, silent = true, desc = "DAP pause (nvim-dap)" },
            { "<leader>dr", function() require("dap").repl.toggle() end, silent = true, desc = "DAP REPL toggle (nvim-dap)" },
            { "<leader>ds", function() require("dap").session() end, silent = true, desc = "DAP session (nvim-dap)" },
            { "<leader>dt", function() require("dap").terminate() end, silent = true, desc = "DAP terminate (nvim-dap)" },
            { "<leader>dw", function() require("dap.ui.widgets").hover() end, silent = true, desc = "DAP hover (nvim-dap)" },
        },
        config = function()
    ...
    },
    {
        ...
        event = "LspAttach",
        keys = {
            { "<leader>du", function() require("dapui").toggle({}) end, silent = true, desc = "DAP UI toggle (nvim-dap-ui)" },
            {
                "<leader>de",
