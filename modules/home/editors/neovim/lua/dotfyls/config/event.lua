vim.api.nvim_create_autocmd({ "BufNewFile", "BufReadPost" }, {
    ...
    callback = function()
        ...
        if vim.lsp.config ~= nil then
            ...
            for _, file in pairs(vim.fn.readdir(vim.fs.joinpath(vim.fn.stdpath("config"), "after", "lsp"))) do
                ...
                if override ~= false then
                    ...
                    if override ~= nil then
                        opts =
                            vim.tbl_deep_extend("force", opts, type(override) == "function" and override() or override)
                    end
