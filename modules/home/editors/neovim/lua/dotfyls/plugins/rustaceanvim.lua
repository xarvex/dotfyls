...
return {
    ...
    config = function()
        ...
        keymap(
            ...
            { silent = true, desc = "Open Cargo.toml (rustaceanvim)" }
        )
        keymap(
            "n",
            "<leader>rD",
            function() vim.cmd.RustLsp("openDocs") end,
            { silent = true, desc = "Open docs.rs (rustaceanvim)" }
        )

        local lsp_opts = vim.lsp.config.rust_analyzer
        ---@module "rustaceanvim"
        ...
        vim.g.rustaceanvim = {
            ...
            server = {
                ...
                default_settings = (lsp_opts ~= nil and lsp_opts.settings ~= nil) and lsp_opts.settings
                    or { ["rust-analyzer"] = {} },
            },
            ---@module "dap"
